...
<?php $__env->startSection('title','Buat Laporan Keuangan'); ?>
...
<div class="container-fluid">
    <div class="card p-3">
       <a href="<?php echo e(route('reports.keuangan.index')); ?>" class="mb-3 d-inline-block text-decoration-none"><i class="fas fa-arrow-left me-2"></i> Kembali</a>
        ...
        <form method="POST" action="<?php echo e(route('reports.keuangan.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-2">
                <label>Judul</label>
                <input type="text" name="judul" class="form-control" value="Laporan Keuangan Bulan <?php echo e(now()->format('F Y')); ?>">
            </div>
            <div class="mb-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\airpay\resources\views/reports/keuangan/create.blade.php ENDPATH**/ ?>